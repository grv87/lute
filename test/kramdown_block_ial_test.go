...
var kramdownBlockIALTests = []parseTest{
	...
	{"21", "* {: id=\"fooid\"}foo\n\n  > bar\n  {: id=\"barid\"}\n{: id=\"id\"}", "<ul id=\"id\">\n<li id=\"fooid\">\n<p>foo</p>\n<blockquote id=\"barid\">\n<p>bar</p>\n</blockquote>\n</li>\n</ul>\n"},
	{"20", "* {: id=\"fooid\"} foo\n{: id=\"id\"}", "<ul id=\"id\">\n<li id=\"fooid\">foo</li>\n</ul>\n"},
	{"19", "* foo\n\n  bar\n  {: id=\"barid\"}\n\n  > baz\n  {: id=\"bazid\"}\n{: id=\"id\"}", "<ul id=\"id\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">\n<p>foo</p>\n<p id=\"barid\">bar</p>\n<blockquote id=\"bazid\">\n<p>baz</p>\n</blockquote>\n</li>\n</ul>\n"},
	{"18", "* foo\n\n  bar\n  {: id=\"barid\"}\n\n  baz\n{: id=\"id\"}", "<ul id=\"id\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">\n<p>foo</p>\n<p id=\"barid\">bar</p>\n<p>baz</p>\n</li>\n</ul>\n"},
	{"17", "> * foo\n>   * bar\n>     * baz\n>\n>       bazz\n>       {: id=\"bazzid\"}\n>     {: id=\"bazid\"}\n>   {: id=\"barid\"}\n> {: id=\"fooid\"}\n{: id=\"id\"}", "<blockquote id=\"id\">\n<ul id=\"fooid\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">foo\n<ul id=\"barid\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">bar\n<ul id=\"bazid\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">\n<p>baz</p>\n<p id=\"bazzid\">bazz</p>\n</li>\n</ul>\n</li>\n</ul>\n</li>\n</ul>\n</blockquote>\n"},
	{"16", "> foo\n> {: id=\"fooid\"}\n> * bar\n> {: id=\"barid\"}\n{: id=\"id\"}", "<blockquote id=\"id\">\n<p id=\"fooid\">foo</p>\n<ul id=\"barid\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">bar</li>\n</ul>\n</blockquote>\n"},
	{"15", "> foo\n>\n> * bar\n> {: id=\"barid\"}\n{: id=\"id\"}", "<blockquote id=\"id\">\n<p>foo</p>\n<ul id=\"barid\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">bar</li>\n</ul>\n</blockquote>\n"},
	{"14", "foo\n{: id=\"fooid\"}\nbar\n{: id=\"barid\"}", "<p id=\"fooid\">foo</p>\n<p id=\"barid\">bar</p>\n"},
	{"13", "foo\n{: id=\"fooid\"}\nbar", "<p id=\"fooid\">foo</p>\n<p>bar</p>\n"},
	{"12", "* foo\n\n  > bar\n  {: id=\"bqid\"}\n  > baz\n  > {: id=\"bazid\"}\n* baz\n  {: id=\"bazid\"}\n{: id=\"id\"}", "<ul id=\"id\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">\n<p>foo</p>\n<blockquote id=\"bqid\">\n<p>bar</p>\n</blockquote>\n<blockquote>\n<p id=\"bazid\">baz</p>\n</blockquote>\n</li>\n<li id=\"0224bmnz8gw0080000000t5cy4\">\n<p id=\"bazid\">baz</p>\n</li>\n</ul>\n"},
	{"11", "* foo\n  * bar\n  * baz\n  {: id=\"subid\"}\n{: id=\"id\"}", "<ul id=\"id\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">foo\n<ul id=\"subid\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">bar</li>\n<li id=\"0224bmnz8gw0080000000t5cy4\">baz</li>\n</ul>\n</li>\n</ul>\n"},
	{"10", "* foo\n  * bar\n  * baz\n  {: id=\"subid\"}\n{: id=\"id\"}", "<ul id=\"id\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">foo\n<ul id=\"subid\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">bar</li>\n<li id=\"0224bmnz8gw0080000000t5cy4\">baz</li>\n</ul>\n</li>\n</ul>\n"},
	{"9", "* foo\n\n  > bar\n  > {: id=\"barid\"}\n  {: id=\"bqid\"}\n\n  baz\n{: id=\"id\"}", "<ul id=\"id\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">\n<p>foo</p>\n<blockquote id=\"bqid\">\n<p id=\"barid\">bar</p>\n</blockquote>\n<p>baz</p>\n</li>\n</ul>\n"},
	{"8", "* foo\n\n  > bar\n  {: id=\"bqid\"}\n{: id=\"id\"}", "<ul id=\"id\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">\n<p>foo</p>\n<blockquote id=\"bqid\">\n<p>bar</p>\n</blockquote>\n</li>\n</ul>\n"},
	{"7", "* > foo\n  {: id=\"bqid\"}\n{: id=\"id\"}", "<ul id=\"id\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">\n<blockquote id=\"bqid\">\n<p>foo</p>\n</blockquote>\n</li>\n</ul>\n"},
	{"6", "* foo\n\n* bar\n  {: id=\"barid\"}\n{: id=\"id\"}", "<ul id=\"id\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">\n<p>foo</p>\n</li>\n<li id=\"0224bmnz8gw0080000000t5cy4\">\n<p id=\"barid\">bar</p>\n</li>\n</ul>\n"},
	{"5", "* foo\n  {: id=\"fooid\"}\n{: id=\"id\"}", "<ul id=\"id\">\n<li id=\"0224bmnz8gw0080000000t5cy4\">foo</li>\n</ul>\n"},
